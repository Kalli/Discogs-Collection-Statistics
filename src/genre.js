...
export class GenresAndStyles extends Component{
	...
	steps(classes, genreData, stylesData, selectedGenre){
		...
		return (
			<div id="genres-and-styles" className={"col-xs-12 col-md-12"}>
				<div className={classnames(classes.scroller, "col-xs-12 col-md-4")}>
					{this.steps(classes, genreData, stylesData, (genre || this.state.selectedGenre) )}
				</div>
